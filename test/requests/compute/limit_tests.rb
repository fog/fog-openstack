...
describe "Fog::OpenStack::Compute | limits requests" do
  ...
  describe "success" do
    describe "#get_limits" do
      it "format" do
        _(Fog::OpenStack::Compute.new.get_limits.body['limits']).
          must_match_schema(@limits_format)
      end

      it "rate limit format" do
        _(Fog::OpenStack::Compute.new.get_limits.body['limits']['rate'].
      ...
      it "absolute limits format" do
        _(Fog::OpenStack::Compute.new.get_limits.body['limits']['absolute']).
