...
describe "Fog::Network[:openstack] | security_grouprule requests" do
  ...
  describe "success" do
    before do
      ...
      @security_group_rule = @network.create_security_group_rule(@sec_group_id, 'ingress', attributes).body["security_group_rule"]
    ...
    it "#get_security_group_rule(@sec_group_rule_id)" do
      @network.get_security_group_rule(@sec_group_rule_id).body["security_group_rule"].must_match_schema(@security_group_rule_format)
    end

    it "#list_security_group_rules" do
      @network.list_security_group_rules.body.must_match_schema("security_group_rules" => [@security_group_rule_format])
    end
