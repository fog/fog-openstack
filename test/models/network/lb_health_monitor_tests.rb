...
describe "Fog::OpenStack::Network | lb_health_monitor" do
  describe "success" do
    ...
    it "#update" do
      ...
      _(@instance.update.expected_codes).must_equal "200"
    end

    it "#associate_to_pool" do
      _(@instance.associate_to_pool(@lb_pool.id)).must_equal true
    end

    it "#disassociate_from_pool" do
      _(@instance.disassociate_from_pool(@lb_pool.id)).must_equal true
    end
